...
public class AlonzoDuplicateKeyBenchmarks
{
    private const int CONCURRENCY_LEVEL = 2;
    private const int ITERATIONS_PER_TASK = 2;

    private readonly string _block = File.ReadAllText(Path.Combine(Directory.GetCurrentDirectory(), "data", "alonzo_with_duplicate_key_block.cbor"));
