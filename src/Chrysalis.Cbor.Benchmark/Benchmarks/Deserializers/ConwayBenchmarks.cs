...
using NewBlock = New::Chrysalis.Cbor.Cardano.Types.Block.ConwayBlock;
using OldBlock = Old::Chrysalis.Cardano.Core.Types.Block.ConwayBlock;
...
public class ConwayBenchmarks
{
    ...
    private readonly string _block = File.ReadAllText(Path.Combine(Directory.GetCurrentDirectory(), "data", "conway_block.cbor"));
