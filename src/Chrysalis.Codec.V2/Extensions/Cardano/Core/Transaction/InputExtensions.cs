using CBlock = Chrysalis.Codec.V2.Types.Cardano.Core.IBlock;
using Chrysalis.Codec.V2.Types.Cardano.Core.Transaction;
using Chrysalis.Codec.V2.Types.Cardano.Core.TransactionWitness;
using Redeemer = Chrysalis.Codec.V2.Types.Cardano.Core.TransactionWitness.RedeemerEntry;
using Chrysalis.Codec.V2.Extensions.Cardano.Core.TransactionWitness;
