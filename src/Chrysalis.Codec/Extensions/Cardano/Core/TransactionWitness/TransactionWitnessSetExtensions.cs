...
using CBootstrapWitness = Chrysalis.Codec.Types.Cardano.Core.TransactionWitness.BootstrapWitness;
using CVKeyWitness = Chrysalis.Codec.Types.Cardano.Core.TransactionWitness.VKeyWitness;
