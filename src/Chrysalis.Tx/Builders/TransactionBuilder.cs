...
public class TransactionBuilder
{
    ...
    public ConwayTransactionBody BuildBody() => ConwayTransactionBody.Create(
        ...
        auxiliaryDataHash: _auxDataHash is not null ? new ReadOnlyMemory<byte>(_auxDataHash) : null,
        validityIntervalStart: _validityStart,
        mint: Mint,
        scriptDataHash: _scriptDataHash is not null ? new ReadOnlyMemory<byte>(_scriptDataHash) : null,
