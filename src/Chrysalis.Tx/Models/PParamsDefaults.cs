...
/// <summary>
/// Provides default protocol parameter values for different Cardano networks.
/// </summary>
public static class PParamsDefaults
{
    /// <summary>
    /// Gets default protocol parameters for the Preview network.
    /// </summary>
    /// <returns>The protocol parameters response for Preview.</returns>
    public static ProtocolParametersResponse Preview()
    {
        ProtocolParametersResponse response = new(
            951,
            44,
            155381,
            90112,
            ...
            "4310",
            "170000000",
            "85a37b10b1811177ae0b7a9eb1bffdc58d441484ad22f251f169eb65ffb8f831",
            GetCostModels(),
            GetCostModelsRaw(),
            0.0577,
            0.0000721,
    ...
    /// <summary>
    /// Gets default protocol parameters for the Mainnet network.
    /// </summary>
    /// <returns>The protocol parameters response for Mainnet.</returns>
    public static ProtocolParametersResponse Mainnet()
    {
        ProtocolParametersResponse response = new(
            561,
            44,
            ...
            "4310",
            "170000000",
            "0edb6e36cefb81e5247fd7be9421bedcba5e4befc99d159d7d936eb843034cd7",
            GetCostModels(),
            GetCostModelsRaw(),
            0.0577,
            0.0000721,
    ...
    private static Dictionary<string, Dictionary<string, int>>? GetCostModels() => new()
    {
        ["PlutusV1"] = new Dictionary<string, int>
        {
        ...
        ["PlutusV2"] = new Dictionary<string, int>
        {
            ["addInteger-cpu-arguments-intercept"] = 100788,
            ["addInteger-cpu-arguments-slope"] = 420,
            ["addInteger-memory-arguments-intercept"] = 1,
        ...
        ["PlutusV3"] = new Dictionary<string, int>
        {
            ["addInteger-cpu-arguments-intercept"] = 100788,
            ["addInteger-cpu-arguments-slope"] = 420,
            ["addInteger-memory-arguments-intercept"] = 1,
    ...
    private static Dictionary<string, int[]> GetCostModelsRaw() => new()
    {
        ["PlutusV1"] =
            [
