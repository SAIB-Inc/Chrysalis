...
public record MintOptions<T>
{
        ...
        where TData : CborBase
    {
        ...
        {
            TData data = factory(mapping, context);
            return new Redeemer<CborBase>(RedeemerTag.Mint, 0, data, new(3500000, 399000000));
        };
        return this;
    }
...
public record WithdrawalOptions<T>
{
        ...
        where TData : CborBase
    {
        ...
        {
            TData data = factory(mapping, context);
            return new Redeemer<CborBase>(RedeemerTag.Reward, 0, data, new ExUnits(3500000, 399000000));
        };
        return this;
    }
