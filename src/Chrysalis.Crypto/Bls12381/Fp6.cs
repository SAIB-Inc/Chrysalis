...
internal static class Fp6
{
    ...
    internal static bool IsZero(Fp6Element a) =>
        Fp2.IsZero(a.C0) && Fp2.IsZero(a.C1) && Fp2.IsZero(a.C2);

    internal static bool Eql(Fp6Element a, Fp6Element b) =>
        Fp2.Eql(a.C0, b.C0) && Fp2.Eql(a.C1, b.C1) && Fp2.Eql(a.C2, b.C2);

    internal static Fp6Element Neg(Fp6Element a) =>
        new(Fp2.Neg(a.C0), Fp2.Neg(a.C1), Fp2.Neg(a.C2));

    internal static Fp6Element Add(Fp6Element a, Fp6Element b) =>
        new(Fp2.Add(a.C0, b.C0), Fp2.Add(a.C1, b.C1), Fp2.Add(a.C2, b.C2));

    internal static Fp6Element Sub(Fp6Element a, Fp6Element b) =>
        new(Fp2.Sub(a.C0, b.C0), Fp2.Sub(a.C1, b.C1), Fp2.Sub(a.C2, b.C2));

    internal static Fp6Element MulScalar(Fp6Element a, BigInteger s) =>
        new(Fp2.MulScalar(a.C0, s), Fp2.MulScalar(a.C1, s), Fp2.MulScalar(a.C2, s));
    ...
    internal static Fp6Element MulByNonresidue(Fp6Element a) =>
        new(Fp2.MulByNonresidue(a.C2), a.C0, a.C1);
    ...
    internal static Fp6Element MulByFp2(Fp6Element a, Fp2Element rhs) =>
        new(Fp2.Mul(a.C0, rhs), Fp2.Mul(a.C1, rhs), Fp2.Mul(a.C2, rhs));
    ...
    internal static byte[] ToBytes(Fp6Element a) =>
        [.. Fp2.ToBytes(a.C0), .. Fp2.ToBytes(a.C1), .. Fp2.ToBytes(a.C2)];
