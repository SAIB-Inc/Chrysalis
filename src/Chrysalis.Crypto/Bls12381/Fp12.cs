...
internal static class Fp12
{
    ...
    internal static Fp12Element Add(Fp12Element a, Fp12Element b) => new(Fp6.Add(a.C0, b.C0), Fp6.Add(a.C1, b.C1));

    internal static Fp12Element Sub(Fp12Element a, Fp12Element b) => new(Fp6.Sub(a.C0, b.C0), Fp6.Sub(a.C1, b.C1));
    ...
    internal static Fp12Element MulScalar(Fp12Element a, BigInteger s) => new(Fp6.MulScalar(a.C0, s), Fp6.MulScalar(a.C1, s));
    ...
    internal static byte[] ToBytes(Fp12Element a) => [.. Fp6.ToBytes(a.C0), .. Fp6.ToBytes(a.C1)];
