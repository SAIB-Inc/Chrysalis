...
/// <summary>
/// Low-level SHA-512 compression function and initialization constants.
/// </summary>
internal static class Sha512Internal
{
    ...
    /// <summary>
    /// Initializes the SHA-512 state with standard IV constants.
    /// </summary>
    ...
    /// <summary>
    /// Performs one round of the SHA-512 compression function.
    /// </summary>
    /// <param name="outputState">The resulting state.</param>
    /// <param name="inputState">The input state.</param>
    /// <param name="input">The 128-byte input block.</param>
            ...
            while (true)
            {
                ...
                {//0
                    ...
                    t2 = ((a >> 28) ^ (a << (64 - 28)) ^ (a >> 34) ^ (a << (64 - 34)) ^ (a >> 39) ^ (a << (64 - 39))) +
                         ((a & b) ^ (a & c) ^ (b & c));
                    h = g; g = f; f = e; e = d + t1; d = c; c = b; b = a; a = t1 + t2; t++;
                }
                {//1
                    t1 = h +
                         ((e >> 14) ^ (e << (64 - 14)) ^ (e >> 18) ^ (e << (64 - 18)) ^ (e >> 41) ^ (e << (64 - 41))) +
