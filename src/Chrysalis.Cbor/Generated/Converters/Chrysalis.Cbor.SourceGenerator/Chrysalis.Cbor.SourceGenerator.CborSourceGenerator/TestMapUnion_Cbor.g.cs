...
public partial record TestMapUnion
{
    ...
    public static new void Write(CborWriter writer, global::Chrysalis.Cbor.Types.Test.TestUnion.TestMapUnion value)
    {
...
writer.WriteEndMap();
    ...
    public static new global::Chrysalis.Cbor.Types.Test.TestUnion.TestMapUnion Read(ReadOnlyMemory<byte> data)
    {
...
reader.ReadEndMap();
var result = new global::Chrysalis.Cbor.Types.Test.TestUnion.TestMapUnion(
    Value1: Value1,
    Value2: Value2,
    Value3: Value3,
    Value4: Value4,
