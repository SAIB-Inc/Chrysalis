...
public partial record NullableTestMapUnion
{
    ...
    public static new void Write(CborWriter writer, global::Chrysalis.Cbor.Types.Test.TestUnion.NullableTestMapUnion value)
    {
...
writer.WriteEndMap();
    ...
    public static new global::Chrysalis.Cbor.Types.Test.TestUnion.NullableTestMapUnion Read(ReadOnlyMemory<byte> data)
    {
...
reader.ReadEndMap();
var result = new global::Chrysalis.Cbor.Types.Test.TestUnion.NullableTestMapUnion(
    Value1: Value1,
    Value2: Value2
);
