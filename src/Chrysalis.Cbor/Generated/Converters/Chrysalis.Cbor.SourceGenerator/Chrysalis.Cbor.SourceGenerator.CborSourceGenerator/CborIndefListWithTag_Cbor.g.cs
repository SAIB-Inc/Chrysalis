...
public partial record CborIndefListWithTag
{
    ...
    public static new void Write(CborWriter writer, global::Chrysalis.Cbor.Types.Custom.CborMaybeIndefList<T>.CborIndefListWithTag value)
    {
        writer.WriteTag(258);
...
writer.WriteEndMap();
    ...
    public static new global::Chrysalis.Cbor.Types.Custom.CborMaybeIndefList<T>.CborIndefListWithTag Read(ReadOnlyMemory<byte> data)
    {
...
reader.ReadEndMap();
var result = new global::Chrysalis.Cbor.Types.Custom.CborMaybeIndefList<T>.CborIndefListWithTag(
    Value: Value
);
