...
internal readonly record struct BuiltinCostModel(CostFunction Cpu, CostFunction Mem)
{
    internal ExBudget Eval(long x, long y, long z) =>
        new(Cpu.Eval(x, y, z), Mem.Eval(x, y, z));
}
