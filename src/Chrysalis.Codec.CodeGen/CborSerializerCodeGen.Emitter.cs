...
public sealed partial class CborSerializerCodeGen
{
    ...
    {
        public const string GenericSerializationUtilFullname = "global::Chrysalis.Codec.Serialization.Utils.GenericSerializationUtil";
        ...
        private static bool IsPrimitiveType(string type)
        {
            return type.Replace("?", "") switch
            {
                ...
                "Chrysalis.Codec.Types.Primitives.CborEncodedValue" => true,
                "global::Chrysalis.Codec.Types.Primitives.CborEncodedValue" => true,
                "CborLabel" => true,
